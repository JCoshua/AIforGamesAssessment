...
Maze::Maze()
{
	...
	TileKey map[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, w, w, w, w, w, w, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, w, w, w, _, _, _, _, w, w, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, w, w, w, w, _, w, w, w, w, w, _, w, w, w, w, _, w, w, w, w, w, _, w, w, w, w, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, w, w, _, _, _, _, _, _, _, _, w },
		{ w, w, _, w, w, w, w, w, _, w, w, w, w, _, p, w, w, w, w, w, _, w, w, w, w, _, w, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, w, w, _, _, _, _, _, _, _, _, w },
		{ w, w, w, w, w, _, w, w, w, w, w, _, w, w, w, w, _, w, w, w, w, w, _, w, w, w, w, w },
